...
def objective(trial: optuna.trial.Trial) -> float:
    ...
    model_params = {
        "d_input_enc": 10000, #TODO: modifier ceci to 5k or 10k when i wanna test on other dataset
...
if __name__ == "__main__":
    ...
    storage_db = optuna.storages.RDBStorage(
                url="sqlite:////home/maoss2/scratch/optuna_test_output_10000/experiment_data_10000.db" # url="sqlite:///:memory:" quand le lien est relatif
            )
    study = optuna.create_study(study_name='experiment_data_10000', 
                                storage=storage_db, 
                                direction="maximize", 
